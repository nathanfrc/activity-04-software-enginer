...
public class ExchangeResource {
	...
	public ResponseEntity<?> find(@PathVariable Integer id) {		
		Exchange obj = service.find(id);		
		return ResponseEntity.ok().body(obj);
	}
	
	@RequestMapping(method = RequestMethod.POST)
	public ResponseEntity<?> insert(@RequestBody Exchange obj) {			
	...
	public ResponseEntity<Void> update(@RequestBody Exchange obj, @PathVariable Integer id) {
		obj.setId(id);
